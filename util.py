...
def predict_transform(prediction, inp_dim, anchors, num_classes, CUDA):
    ...
    prediction[:, :, 2:4] = torch.exp(prediction[:, :, 2:4]).cuda() * anchors
...
def write_results(prediction, confidence, num_classes, nms_conf=0.4):
    ...
    write = False  # We haven't initialized the tensor we will use to collect the true detections across the entire batch
